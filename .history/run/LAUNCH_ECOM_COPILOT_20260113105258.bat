REM --- Suppliers Stub API (5000) ---
start "Ecom Copilot Suppliers Stub (5000)" cmd /k ^
  "cd /d ""C:\Users\Kylem\OneDrive - Copy and Paste LLC\Bwaaack\Ecom Copilot\api-stub"" && node server.cjs"
...
start "Ecom Copilot Suppliers Stub (5000)" cmd /k "cd /d "%ROOT%\api-stub" && node server.cjs"
